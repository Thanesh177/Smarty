...
import SmartyLanding from '../components/landing/SmartyLanding';
...
export default function FeedPage({ onOpenSearch }) {
  const { user } = useAuth();
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (!page || selectedTopic || page.classList.contains('has-smarty-landing')) return undefined;
